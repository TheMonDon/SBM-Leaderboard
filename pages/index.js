    ...
    <div className="bg-background h-screen w-screen flex flex-col overflow-x-hidden">
      <div className="flex flex-row pt-10">
        ...
        <div className="flex w-1/4 mx-auto justify-center border-red-500">
          <div className="flex flex-col w-full">
            {loggedIn ?
              steamLinked ? (<div className="flex flex-col">
                ...
                <div>
                  <h1 className="self-center pt-2 text-3xl text-primary-3 text-center">You must link your steam account
      ...
      <div className="flex flex-row justify-center mt-auto">
        <div className="flex flex-col text-primary-3 text-center m-4">
          ...
          <a href="https://github.com/OneAndonlyFinbar/dbm-leaderboard" className="mx-auto mt-1" target="_blank"><AiFillGithub/></a>
        </div>
      </div>
    </div>
  );
